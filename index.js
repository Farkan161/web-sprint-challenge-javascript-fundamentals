...
function animalNames(zooAnimals) {
  ...
  */
  ...
  function lowerCaseNames(zooAnimals){
    ...
    const newArray = zooAnimals.map(function(zooData){
      return zooData.animal_name.toLowerCase()
    });
    return newArray;
  }
  ...
  */
  ...
  const smallPopulation= zooAnimals.filter(function(zooData){
        return zooData.population < 5;
  });
  ...
  */
  ...
  function USApop(zooAnimals){
    ...
    const reducedPop = zooAnimals.reduce(function(accumulator, currentValue){
